...
urlpatterns = [
    ...
    path('park_in_slot/<str:parking_lot_id>/<str:slot_id>/<str:user_id>/', views.ParkInSlot.as_view(), name="park_in_slot"), # parking initiated by user
    path('park_in_slot/<str:parking_lot_id>/<str:slot_id>/', views.ParkInSlot.as_view(), name="park_in_slot"), # parking initiated by sensor
]