...
urlpatterns = [
    ...
    path('nearest_open_slots/<str:parking_lot_id>/', views.NearestOpenSlots.as_view(), name="nearest_open_slots"), # the nearest unoccupied, unreserved slots
    ...
    path('slot_status/<str:uuid>/', views.SlotStatus.as_view(), name="slot_status"),
    ...
    path('reserve_slot/<str:slot_id>/<str:user_id>/', views.ReserveSlot.as_view(), name="reserve_slot"),
    path('cancel_reservation/<str:slot_id>/<str:user_id>/', views.CancelReservation.as_view(), name="cancel_reservation"),
